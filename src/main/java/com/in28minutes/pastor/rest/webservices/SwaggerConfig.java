...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Patryk Pastor","www.programuje-my.pl","pastor.patryk@gmail.com");
	...
	private static final Set<String> DEFAULT_CONSUMES_AND_PRODUCES = new HashSet<String>(Arrays.asList("Application/JSON"));
